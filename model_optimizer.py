...
def split_X_y(
    ...
    X_train = data.drop(columns=non_features).copy()
    y_train = data[target].astype("float64")
    # Instantiate and returnwrapper object
    training_dataset = TrainingSet(X=X_train, y=y_train)
...
def main(
    ...
    data_to_model: Dict[str, TrainingSet] = {}
    ...
    for data_file in data_files:
        ...
        data_to_model[data_file.stem] = training_data
